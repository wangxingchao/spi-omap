				  ...
				  struct snd_soc_dai *dai)
{
	...
	int ret;
        ...
        /* add by embest */
//        snd_soc_write(codec, SGTL5000_CHIP_ANA_HP_CTRL, 0x0101);
...
#if 0
	/* add by embest */
	ret = snd_soc_read(codec, SGTL5000_CHIP_DAC_VOL);	
	printk("--------SGTL5000_CHIP_DAC_VOL= 0x%x\n", ret);

	ret = snd_soc_read(codec, SGTL5000_CHIP_ANA_HP_CTRL);
	printk("--------SGTL5000_CHIP_ANA_HP_CTRL= 0x%x\n", ret);

	ret = snd_soc_read(codec, SGTL5000_CHIP_MIC_CTRL);
	printk("--------SGTL5000_CHIP_MIC_CTRL= 0x%x\n", ret);

	ret = snd_soc_read(codec, SGTL5000_CHIP_ANA_CTRL);
	printk("--------SGTL5000_CHIP_ANA_CTRL= 0x%s\n", ret); 

	ret = snd_soc_read(codec, SGTL5000_CHIP_ANA_ADC_CTRL);
	printk("--------SGTL5000_CHIP_ANA_ADC_CTRL= 0x%x\n", ret); 

	ret = snd_soc_read(codec, SGTL5000_CHIP_ANA_POWER);
	printk("--------SGTL5000_CHIP_ANA_POWER= 0x%x\n", ret);
	/* end add */
#endif
	return 0;
}
